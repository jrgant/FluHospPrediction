...
#SBATCH -J SL-FluHosp-TARGET-cumhosp_LAMBDA-lambda-min_SENS-ElastNetRF
#SBATCH -p batch
#SBATCH --time=3:30:00
#SBATCH --mem=150GB
#SBATCH -n 32
...
#SBATCH --array=01-30
#SBATCH -o SL-FluHosp-TARGET_cumhosp-LAMBDA-lambda-min_SENS-ElastNetRF-ArrayID-%A-JobID-%J-Week-%2a.log
...
export LEARNER_SELECT='elast|rf'
