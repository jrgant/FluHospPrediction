...
#SBATCH -J SL-FluHosp-TARGET-cumhosp_LAMBDA-lambda-min_SENS-SqErrLoss
#SBATCH --time=3:30:00
#SBATCH -p batch
#SBATCH --mem=100GB
#SBATCH -n 32
...
#SBATCH -o SL-FluHosp-TARGET-cumhosp_LAMBDA-lambda-min_SENS-SqErrLoss-ArrayID-%A-JobID-%J-Week-%2a.log
