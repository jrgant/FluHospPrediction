...
4. Once `renv` has installed itself, run the code below. Ideally, the user could run `renv::restore()` to install all dependencies, but the `sl3` and `randomForest` versions required can't be installed automatically.
