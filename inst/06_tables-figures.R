...
prsens_rwsum <- rbindlist(
  list(
    main = pkrate_rwsum,
    l1se = pkrate_rwsum_1se,
    erf = pkrate_rwsum_erf
  ),
  idcol = "analysis"
)
...
prsens_risktabs <- rbindlist(
  list(
    main = rbindlist(sl_pkrate_risktables),
    l1se = rbindlist(sl_pkrate_risktables_1se),
    erf = rbindlist(sl_pkrate_risktables_erf)
  ),
  idcol = "analysis"
)

prsens_risktabs <- prsens_risktabs[learner != "SuperLearner"]
prsens_risktabs
